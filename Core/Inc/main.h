...
#define PHOTO0_EXTI_IRQn EXTI0_IRQn
#define RMII_MDC_Pin GPIO_PIN_1
#define RMII_MDC_GPIO_Port GPIOC
#define PHOTO1_Pin GPIO_PIN_2
#define PHOTO1_GPIO_Port GPIOC
#define PHOTO1_EXTI_IRQn EXTI2_IRQn
#define PHOTO2_Pin GPIO_PIN_3
#define PHOTO2_GPIO_Port GPIOC
#define PHOTO2_EXTI_IRQn EXTI3_IRQn
...
#define FND6_Pin GPIO_PIN_1
#define FND6_GPIO_Port GPIOB
#define FND4_Pin GPIO_PIN_2
...
#define FND5_Pin GPIO_PIN_10
#define FND5_GPIO_Port GPIOB
#define FND7_Pin GPIO_PIN_11
...
#define FND2_Pin GPIO_PIN_3
#define FND2_GPIO_Port GPIOB
#define FND1_Pin GPIO_PIN_4
#define FND1_GPIO_Port GPIOB
#define FND9_Pin GPIO_PIN_5
#define FND9_GPIO_Port GPIOB
#define FND10_Pin GPIO_PIN_6
#define FND10_GPIO_Port GPIOB
