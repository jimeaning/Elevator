...
extern void step_motor_main_test(void);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|FND6_Pin|FND4_Pin|FND5_Pin
                          |FND7_Pin|LD3_Pin|FND2_Pin|FND1_Pin
                          |FND9_Pin|FND10_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD1_Pin FND6_Pin FND4_Pin FND5_Pin
                           FND7_Pin LD3_Pin FND2_Pin FND1_Pin
                           FND9_Pin FND10_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|FND6_Pin|FND4_Pin|FND5_Pin
                          |FND7_Pin|LD3_Pin|FND2_Pin|FND1_Pin
                          |FND9_Pin|FND10_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : BUTTON3_Pin BUTTON2_Pin BUTTON4_Pin BUTTON1_Pin
                           BUTTON0_Pin */
  GPIO_InitStruct.Pin = BUTTON3_Pin|BUTTON2_Pin|BUTTON4_Pin|BUTTON1_Pin
                          |BUTTON0_Pin;
...
void Task3_func(void *argument)
{
  ...
  {
	  if (adcValue[0] < 2800) {
		  printf("엘리베이터 현재 꼭대기층 위치");

		  i2c_lcd_init();
		  char lcd_buff[40];

		  sprintf(lcd_buff, "====TOP FLOOR====");
		  move_cursor(0, 0);
		  lcd_string(lcd_buff);
	  }
    osDelay(1);
